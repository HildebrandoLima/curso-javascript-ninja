(function(){
  ...
  */
  ...
  console.log( text.replace( /Manuel Marques de Sousa/g, 'Hill' );
  ...
  */
  ...
  console.log( text.replace( '\n'/O Centauro de Luvas/g, function(phrase){
    reuturn phrase.toUpperCase();
  }) );
  ...
  */
  ...
  function getMonthNumber( mothName ) {
    var moths = {
      janeiro: '01',
      fevereiro: '02',
      março: '03',
